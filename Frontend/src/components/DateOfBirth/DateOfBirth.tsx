    ...
    <div>
      <div>
        <div className='min-w-[20rem] w-[25rem] items-center justify-center flex gap-4 text-center mb-2'>
          {/* Tháng */}
          <div className='border-2 rounded-lg hover:border-blue-500 border-gray-400 w-[15rem] h-[4rem]  '>
          ...
          {/* Ngày */}
          <div className='border-2 rounded-lg hover:border-blue-500 border-gray-400 w-[8rem] h-[4rem]'>
          ...
          {/* Năm */}
          <div className='border-2 rounded-lg hover:border-blue-500 border-gray-400 w-[10rem] h-[4rem]'>
