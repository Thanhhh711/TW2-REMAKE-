          ...
          <div className='flex justify-between     mx-auto w-full '>
            ...
            <div className='w-[50%] h-[100%]   flex-col   justify-start  flex-nowrap'>
              <div className='      mt-0 mb-10  '>
                <h1 className='text-white text-[5rem] font-semibold text-left block font-segoe'>
                  Đang diễn ra ngay bây giờ
                </h1>
                <h3 className='text-white text-[3rem] font-semibold text-left block mt-3 font-segoe'>
                  Tham gia ngay.{' '}
                </h3>
              </div>

              {/* nút đăng nhập */}
              <div className='justify-start ml-0 flex-nowrap  '>
                ...
                <div className='my-1 justify-start flex-nowrap'>
                  <div className=' ml-0   '>
                    <button className='text-white my-2 font-bold rounded-3xl  block bg-blue-400 text-center w-[18rem] h-[2.5rem] hover:bg-blue-600'>
                      Tạo tài khoản
                    </button>
                  </div>
